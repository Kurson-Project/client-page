...
export const FormTemplate: React.FC<FormTemplateProps> = ({ title, subtitle, children, onSubmit, btnAction }) => {
  ...
  return (
    <main className="w-full h-screen overflow-hidden flex">
      ...
      <div className="absolute z-10 top-2 left-4">
        <Button onClick={() => navigate("/")} variant={"ghost"} className="font-bold text-2xl">
          Lumino
        </Button>
      </div>
          ...
          <form onSubmit={onSubmit} autoComplete="on" className="max-w-[400px] flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col">
                <Button type="submit" className="w-full text-foreground ">{loading ? "Loading..." : btnAction}</Button>
